...
variable "eso_image_version" {
  ...
  default     = "v1.1.1-ubi@sha256:ae2fa4fa336b1fc02b22d6f80b9efc9f050cc7900bca9aa33425afad904fdecf" # datasource: ghcr.io/external-secrets/external-secrets
  nullable    = false
  validation {
...
variable "eso_chart_version" {
  ...
  default     = "1.1.1" # registryUrl: charts.external-secrets.io
  nullable    = false
}
